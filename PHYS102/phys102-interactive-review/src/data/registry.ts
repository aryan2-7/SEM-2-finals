...
export const topics: TopicMeta[] = [
  // Ch1
  { id: 'vectors-basics', chapterId: 'ch1', title: 'Scalars, Vectors & Notation', featured: true },
  { id: 'vector-addition', chapterId: 'ch1', title: 'Addition & Scalar Multiplication', featured: true },
  { id: 'dot-cross', chapterId: 'ch1', title: 'Dot & Cross Product', featured: true },
  { id: 'component-form', chapterId: 'ch1', title: 'Component Form & Calculator', featured: true },
  ...
  { id: 'e-field-point', chapterId: 'ch2', title: 'Field of a Point Charge', featured: true },
  { id: 'continuous-dist', chapterId: 'ch2', title: 'Continuous Distributions', featured: true },
  { id: 'standard-derivations', chapterId: 'ch2', title: 'Standard E-field Derivations', featured: true },
  { id: 'field-lines', chapterId: 'ch2', title: 'Field Lines', featured: true },
  { id: 'gauss-law', chapterId: 'ch2', title: "Gauss's Law", featured: true },
  { id: 'potential', chapterId: 'ch2', title: 'Electric Potential', featured: true },
  { id: 'work-energy', chapterId: 'ch2', title: 'Work & Energy', featured: true },
  { id: 'conductors', chapterId: 'ch2', title: 'Conductors', featured: true },

  // Ch3
  { id: 'dipole-moment', chapterId: 'ch3', title: 'Electric Dipole & Moment', featured: true },
